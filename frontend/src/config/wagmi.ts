...
// Minimal Web3Modal metadata - use localhost for local testing
const metadata = {
  name: 'ApeChain NFT Raffles',
  description: 'Decentralized NFT raffle platform on ApeChain',
  url: 'http://localhost:3000', // Use localhost for better local compatibility
...
// Create Web3Modal with mobile-first configuration
createWeb3Modal({
  wagmiConfig: config,
  projectId,
  ...
  // Show all wallets for better mobile compatibility
  allWallets: 'SHOW',
