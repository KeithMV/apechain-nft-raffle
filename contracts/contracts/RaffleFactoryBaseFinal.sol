...
/**
 * @title RaffleFactoryBaseFinal - Working Base Factory
 * @dev Uses pre-deployed template to avoid contract creation issues
 */
contract RaffleFactoryBaseFinal is Ownable, ReentrancyGuard, Pausable {
    ...
    function createRaffle(
        ...
        // Clone pre-deployed template (this should work on Base)
